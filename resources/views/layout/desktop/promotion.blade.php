...
@section('content')
    <style>
        ...
        #promotion-content i,
        #provider-event-content i {
            margin-right: 8px;
            /* Adjust the spacing between icon and text */
        }
    </style>
    <style>
        #content-promo-list-x {
            margin-left: 20px;
            /* Adjust margin-left to create space */
        }
    </style>
    <link rel="stylesheet" href="../../../assets/css/promotion/promotion.css">
    <div class="site-content-container">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="standard-container-with-sidebar">
                        <div class="promotion-side-menu">
                            <h5>
                                Kategori
                            </h5>
                            <div class="top-tab-container promotion">
                                <a href="#" id="promotion-tab">
                                    Promosi
                                </a>
                                <a href="#" id="provider-event-tab">
                                    Event Provider
                                </a>
                            </div>
                            <a href="#" id="promotion-content" data-active="true" style="text-align: center">
                                <i class="fas fa-gift fa-xl" style="color: #2ca38f"></i> Promosi
                            </a>
                            <a href="#" id="provider-event-content" style="display: none; text-align: center">
                                <i class="fas fa-calendar-alt fa-xl" style="color: #2ca38f"></i> Semua Event Provider
                            </a>
                        </div>
                        <div class="promotion-list" id="content-promo-list-x">
                            @foreach ($promotion as $promotion)
                                <div class="promotion-item" style="margin-top: 20px;">
