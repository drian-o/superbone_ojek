                            ...
                            @foreach ($gamelist as $gamelist)
                                <div class="game-item" data-game="{{ $gamelist->game_name }}" data-match="true"
                                    ...
                                    <div class="wrapper-container"><img src="{{ $gamelist->game_image }}"
                                        ...
                                        <div class="link-container"><a class="play-now"
                                                data-game="{{ $gamelist->game_name }}"
                                                href="javascript:registerPopup({ content:'Silahkan login terlebih dahulu.' });">MAIN</a><a
                                                class="free-play">COBA</a></div>
                                    </div>
