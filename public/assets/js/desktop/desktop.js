...
!(function (e, t) {
            ...
            return (
                o.forEach(function (e, t) {
                    var r = {
                        ...
                        tabPostProcessor:
                            n.tabsPostProcessors && n.tabsPostProcessors[t],
                    };
    ...
    function s(e, t, n, r) {
        var a = A.getNewElScrollerElementWrappingNavTabsInstance(
                e.clone(!0),
                t
            ),
            i = new o(a),
            s = e.data("scrtabs");
        return (
            s ? (s.scroller = a) : e.data("scrtabs", { scroller: a }),
            e.replaceWith(a.css("visibility", "hidden")),
            t.tabClickHandler &&
                "function" == typeof t.tabClickHandler &&
                ((a.hasTabClickHandler = !0),
    ...
    function c(e) {
        ...
        return (
            o[s.title] !== i[s.title] &&
                (r.find('a[role="tab"]').html((o[s.title] = i[s.title])),
                (l = !0)),
            o[s.disabled] !== i[s.disabled] &&
                (i[s.disabled]
                    ? (r.addClass("disabled"),
                      r.find('a[role="tab"]').attr("data-toggle", ""))
                    : (r.removeClass("disabled"),
                      r.find('a[role="tab"]').attr("data-toggle", "tab")),
                (o[s.disabled] = i[s.disabled]),
                (l = !0)),
            e.options.forceActiveTab &&
                (r[i[s.active] ? "addClass" : "removeClass"]("active"),
                a[i[s.active] ? "addClass" : "removeClass"]("active"),
                (o[s.active] = i[s.active]),
                (l = !0)),
            n ||
                o[s.content] === i[s.content] ||
                (a.html((o[s.content] = i[s.content])), (l = !0)),
            l
        );
    }
    function d(e) {
        ...
        return (
            -1 === n.newIdx &&
            (a.hasClass("active") &&
                (t = L.getIndexOfClosestEnabledTab(
                    e.$currTabLis,
                    n.currDomIdx
                )) > -1 &&
                (e.$currTabLis.eq(t).addClass("active"),
    ...
    function C(t, n) {
        ...
        function a(r) {
            ...
            (o = c
                .find(".dropdown-menu")
                .attr("data-" + T.DATA_KEY_DDMENU_MODIFIED, !0)),
    ...
    function u(t, n) {
        t.data("scrtabs") &&
            ((!t.data("scrtabs").isWrapperOnly && v(t, n)) ||
                e("body").trigger(T.EVENTS.FORCE_REFRESH));
    }
    function h() {
        var t = e(this),
            n = t.data("scrtabs");
    ...
    function S() {
        ...
        if (a) {
            for (
                "self" === a.enableSwipingElement
                    ? r.removeClass(T.CSS_CLASSES.ALLOW_SCROLLBAR)
                    : "parent" === a.enableSwipingElement &&
                      r
                          .closest(".scrtabs-tab-container")
                          .parent()
                          .removeClass(T.CSS_CLASSES.ALLOW_SCROLLBAR),
                    a.scroller
                        .off(T.EVENTS.DROPDOWN_MENU_SHOW)
                        .off(T.EVENTS.DROPDOWN_MENU_HIDE),
                    a.scroller
                        .find("[data-" + T.DATA_KEY_DDMENU_MODIFIED + "]")
                        .css({ display: "", left: "", top: "" })
                        .off(T.EVENTS.CLICK)
                        .removeAttr("data-" + T.DATA_KEY_DDMENU_MODIFIED),
                    a.scroller.hasTabClickHandler &&
                        r.find('a[data-toggle="tab"]').off(".scrtabs"),
                    a.isWrapperOnly
                        ? ((n = r.parents(".scrtabs-tab-container")),
                          n.length && n.replaceWith(r))
                        : (a.scroller &&
                              a.scroller.initTabs &&
                              (a.scroller.initTabs = null),
                          r
                              .find(".scrtabs-tab-container")
                              .add(".tab-content")
                              .remove()),
                    r.removeData("scrtabs");
                --e.fn.scrollingTabs.nextInstanceId >= 0;

            )
                e(t).off(
                    T.EVENTS.WINDOW_RESIZE + e.fn.scrollingTabs.nextInstanceId
                );
    ...
    var T = {
        ...
        SLIDE_DIRECTION: { LEFT: 1, RIGHT: 2 },
        EVENTS: {
            CLICK: "click.scrtabs",
            ...
            (n.initElements = function (e) {
                    ...
                    a.$movableContainer
                        ...
                        .on(i.TOUCH_MOVE, function (r) {
                            if (s) {
                                ...
                                a.$movableContainer.css(
                                    d,
                                    o.getMovableContainerCssLeftVal()
                                ),
                ...
                (n.refreshAllElementSizes = function () {
                    var e,
                        ...
                        o = { didScrollToActiveTab: !1 },
                        i = !1;
                    return (
                        t.setElementWidths(),
                        t.setScrollArrowVisibility(),
                        n.scrollArrowsVisible
                            ? ((e = r.getMinPos()),
                              (i = r.scrollToActiveTab({
                                  isOnWindowResize: !0,
                              })),
                              i ||
                                  (r.refreshScrollArrowsDisabledState(),
                                  n.rtl
                                      ? n.movableContainerRightPos < e &&
                                        r.incrementMovableContainerLeft(e)
                                      : n.movableContainerLeftPos < e &&
                                        r.incrementMovableContainerRight(e)),
                              (o.didScrollToActiveTab = !0))
                            : a &&
                              ((n.movableContainerLeftPos = 0),
                ...
                (n.setElementReferences = function (n) {
                    ...
                    (l.isNavPills = !1),
                        ...
                        l.usingBootstrap4 &&
                            c.addClass(T.CSS_CLASSES.BOOTSTRAP4),
                        (l.$fixedContainer = c.find(
                        ...
                        n.leftArrowContent &&
                            (o = r.find(
                                "." + T.CSS_CLASSES.SCROLL_ARROW_CLICK_TARGET
                            )),
                        n.rightArrowContent &&
                            (i = a.find(
                                "." + T.CSS_CLASSES.SCROLL_ARROW_CLICK_TARGET
                        ...
                        o && o.length
                            ? r.addClass(
                                  T.CSS_CLASSES.SCROLL_ARROW_WITH_CLICK_TARGET
                              )
                            : (o = r),
                        i && i.length
                            ? a.addClass(
                            ...
                            : (i = a),
                        (l.$movableContainer = c.find(
                            ".scrtabs-tabs-movable-container"
                        )),
                        (l.$tabsUl = c.find(".nav-tabs")),
                        l.$tabsUl.length ||
                            ((l.$tabsUl = c.find(".nav-pills")),
                            l.$tabsUl.length && (l.isNavPills = !0)),
                        (l.$tabsLiCollection = l.$tabsUl.find("> li")),
                        (l.$slideLeftArrow = l.reverseScroll ? r : a),
                        (l.$slideLeftArrowClickTarget = l.reverseScroll
                            ? o
                            : i),
                        (l.$slideRightArrow = l.reverseScroll ? a : r),
                        (l.$slideRightArrowClickTarget = l.reverseScroll
                            ? i
                            : o),
                        (l.$scrollArrows = l.$slideLeftArrow.add(
                            l.$slideRightArrow
                        )),
                        (l.$win = e(t));
                }),
                (n.setElementWidths = function () {
                    ...
                    (t.winWidth = t.$win.width()),
                        (t.scrollArrowsCombinedWidth =
                            t.$slideLeftArrow.outerWidth() +
                            t.$slideRightArrow.outerWidth()),
                ...
                (n.setEventListeners = function (t) {
                    ...
                    t.enableSwiping && n.listenForTouchEvents(),
                        r.$slideLeftArrowClickTarget
                            .off(".scrtabs")
                            .on(o.MOUSEDOWN, function (e) {
                                a.handleMousedownOnSlideMovContainerLeftArrow.call(
                                    a,
                                    e
                                );
                            })
                            .on(o.MOUSEUP, function (e) {
                                a.handleMouseupOnSlideMovContainerLeftArrow.call(
                                    a,
                                    e
                                );
                            })
                            .on(o.CLICK, function (e) {
                                a.handleClickOnSlideMovContainerLeftArrow.call(
                                    a,
                                    e
                                );
                            }),
                        r.$slideRightArrowClickTarget
                            .off(".scrtabs")
                            .on(o.MOUSEDOWN, function (e) {
                                a.handleMousedownOnSlideMovContainerRightArrow.call(
                                    a,
                                    e
                                );
                            })
                            .on(o.MOUSEUP, function (e) {
                                a.handleMouseupOnSlideMovContainerRightArrow.call(
                                    a,
                                    e
                                );
                            })
                            .on(o.CLICK, function (e) {
                                a.handleClickOnSlideMovContainerRightArrow.call(
                                    a,
                                    e
                                );
                            }),
                        r.tabClickHandler &&
                            r.$tabsLiCollection
                                ...
                                .off(o.CLICK)
                                .on(o.CLICK, r.tabClickHandler),
                        r.$win.off(i).smartresizeScrtabs(function (e) {
                            a.handleWindowResize.call(a, e);
                        }, i),
                        e("body").on(
                            T.EVENTS.FORCE_REFRESH,
                            r.elementsHandler.refreshAllElementSizes.bind(
                                r.elementsHandler
                            )
                        );
                }),
                (n.setFixedContainerWidth = function () {
                    ...
                    (t.fixedContainerWidth = n.width || n.right - n.left),
                        (t.fixedContainerWidth =
                            t.fixedContainerWidth * t.widthMultiplier),
                ...
                (n.setFixedContainerWidthForVisibleScrollArrows = function () {
                    var e = this,
                        t = e.stc;
                    t.$fixedContainer.width(
                        t.fixedContainerWidth - t.scrollArrowsCombinedWidth
                    );
                }),
                    ...
                    (n.movableContainerWidth = 0),
                        r.length &&
                            (r.each(function () {
                                ...
                                n.isNavPills &&
                                    (r =
                                        parseInt(t.css("margin-left"), 10) +
                                        parseInt(t.css("margin-right"), 10)),
                                    (n.movableContainerWidth +=
                                        t.outerWidth() + r);
                            }),
                            (n.movableContainerWidth += 1),
                            n.movableContainerWidth < n.fixedContainerWidth &&
                                (n.movableContainerWidth =
                                    n.fixedContainerWidth)),
                ...
                (n.setScrollArrowVisibility = function () {
                    ...
                    n && !t.scrollArrowsVisible
                        ? (t.$scrollArrows.show(), (t.scrollArrowsVisible = !0))
                        : !n &&
                          t.scrollArrowsVisible &&
                          (t.$scrollArrows.hide(),
                          (t.scrollArrowsVisible = !1)),
                        t.scrollArrowsVisible
                            ? e.setFixedContainerWidthForVisibleScrollArrows()
                            : e.setFixedContainerWidthForHiddenScrollArrows();
                });
        })(n.prototype),
        (function (e) {
            (e.handleClickOnSlideMovContainerLeftArrow = function () {
                ...
                (e.handleMousedownOnSlideMovContainerLeftArrow = function () {
                    var e = this,
                        t = e.stc;
                    t.$slideLeftArrowClickTarget.data(
                        T.DATA_KEY_IS_MOUSEDOWN,
                        !0
                    ),
                ...
                (e.handleMousedownOnSlideMovContainerRightArrow = function () {
                    var e = this,
                        t = e.stc;
                    t.$slideRightArrowClickTarget.data(
                        T.DATA_KEY_IS_MOUSEDOWN,
                        !0
                    ),
                ...
                (e.handleMouseupOnSlideMovContainerLeftArrow = function () {
                    this.stc.$slideLeftArrowClickTarget.data(
                        T.DATA_KEY_IS_MOUSEDOWN,
                        !1
                    );
                }),
                (e.handleMouseupOnSlideMovContainerRightArrow = function () {
                    this.stc.$slideRightArrowClickTarget.data(
                        T.DATA_KEY_IS_MOUSEDOWN,
                        !1
                    );
                }),
        ...
        (function (t) {
            (t.continueSlideMovableContainerLeft = function () {
                var e = this,
                    t = e.stc;
                setTimeout(function () {
                    t.movableContainerLeftPos <= e.getMinPos() ||
                        !t.$slideLeftArrowClickTarget.data(
                            T.DATA_KEY_IS_MOUSEDOWN
                        ) ||
                        e.incrementMovableContainerLeft() ||
                        e.continueSlideMovableContainerLeft();
                ...
                (t.continueSlideMovableContainerRight = function () {
                    var e = this,
                        t = e.stc;
                    setTimeout(function () {
                        t.movableContainerLeftPos >= 0 ||
                            !t.$slideRightArrowClickTarget.data(
                                T.DATA_KEY_IS_MOUSEDOWN
                            ) ||
                            e.incrementMovableContainerRight() ||
                            e.continueSlideMovableContainerRight();
                    }, T.CONTINUOUS_SCROLLING_TIMEOUT_INTERVAL);
                }),
                (t.decrementMovableContainerLeftPos = function (e) {
                    ...
                    (n.movableContainerLeftPos -=
                        ...
                        n.movableContainerLeftPos < e
                            ? (n.movableContainerLeftPos = e)
                            : n.scrollToTabEdge &&
                              (t.setMovableContainerLeftPosToTabEdge(
                                  T.SLIDE_DIRECTION.LEFT
                              ),
                              n.movableContainerLeftPos < e &&
                                  (n.movableContainerLeftPos = e));
                }),
                (t.disableSlideLeftArrow = function () {
                    var e = this,
                        t = e.stc;
                    t.disableScrollArrowsOnFullyScrolled &&
                        t.scrollArrowsVisible &&
                        t.$slideLeftArrow.addClass(
                            T.CSS_CLASSES.SCROLL_ARROW_DISABLE
                        );
                }),
                ...
                (t.getMovableContainerCssLeftVal = function () {
                    var e = this,
                        t = e.stc;
                    return 0 === t.movableContainerLeftPos
                        ? "0"
                        : t.movableContainerLeftPos + "px";
                }),
                (t.incrementMovableContainerLeft = function () {
                    var e = this,
                        ...
                        n = e.getMinPos();
                    return (
                        e.decrementMovableContainerLeftPos(n),
                ...
                (t.incrementMovableContainerRight = function (e) {
                    ...
                    return (
                        e
                            ...
                            : ((n.movableContainerLeftPos +=
                                  n.fixedContainerWidth /
                                  T.SCROLL_OFFSET_FRACTION),
                              n.movableContainerLeftPos > 0
                                  ? (n.movableContainerLeftPos = 0)
                                  : n.scrollToTabEdge &&
                                    t.setMovableContainerLeftPosToTabEdge(
                                        T.SLIDE_DIRECTION.RIGHT
                                    )),
                ...
                (t.scrollToActiveTab = function () {
                    var e,
                        ...
                        l = s.stc;
                    if (
                        l.scrollArrowsVisible &&
                        (l.usingBootstrap4
                            ? ((t = l.$tabsUl.find("li > .nav-link.active")),
                              t.length && (e = t.parent()))
                            : (e = l.$tabsUl.find("li.active")),
                        e && e.length)
                    ) {
                        if (
                            ((i = l.$slideRightArrow.outerWidth()),
                            (n =
                                e.offset().left -
                                l.$fixedContainer.offset().left),
                            (r = n + e.outerWidth()),
                            (a = l.fixedContainerWidth - i),
                            l.rtl)
                        ) {
                            if (((o = l.$slideLeftArrow.outerWidth()), n < 0))
                                return (
                                    (l.movableContainerLeftPos += n),
                                    s.slideMovableContainerToLeftPos(),
                                    !0
                                );
                            if (r > a)
                                return (
                                    (l.movableContainerLeftPos +=
                                        r - a + 2 * i),
                                    s.slideMovableContainerToLeftPos(),
                                    !0
                                );
                            ...
                            if (r > a)
                                return (
                                    (l.movableContainerLeftPos -= r - a + i),
                                    s.slideMovableContainerToLeftPos(),
                                    !0
                                );
                            if (((o = l.$slideLeftArrow.outerWidth()), n < o))
                                return (
                                    (l.movableContainerLeftPos += o - n),
                                    s.slideMovableContainerToLeftPos(),
                                    !0
                                );
                        }
                ...
                (t.setMovableContainerLeftPosToTabEdge = function (t) {
                    ...
                    r.$tabsLiCollection.each(function () {
                        ...
                        if ((o += n) > a)
                            return (
                                (r.movableContainerLeftPos =
                                    t === T.SLIDE_DIRECTION.RIGHT
                                        ? -(o - n)
                                        : -o),
                                !1
                            );
        ...
        (function (t) {
            (t.initTabs = function (t, n, r, a) {
                ...
                t.enableRtlSupport &&
                    ...
                    t.disableScrollArrowsOnFullyScrolled &&
                        (s.disableScrollArrowsOnFullyScrolled = !0),
                    t.reverseScroll && (s.reverseScroll = !0),
                    1 !== t.widthMultiplier &&
                        ((i = Number(t.widthMultiplier)),
                        isNaN(i) || (s.widthMultiplier = i)),
                    "4" === t.bootstrapVersion.toString().charAt(0) &&
                        (s.usingBootstrap4 = !0),
                    setTimeout(o, 100);
            }),
    ...
    var A = (function () {
                ...
                var r = e('<div class="scrtabs-tab-container"></div>'),
                    ...
                    i =
                        ...
                        '<div class="scrtabs-tab-scroll-arrow scrtabs-tab-scroll-arrow-right"><span class="' +
                            n.cssClassRightArrow +
                            '"></span></div>',
                    s = e(i),
                    l = e('<div class="scrtabs-tabs-fixed-container"></div>'),
                    c = e('<div class="scrtabs-tabs-movable-container"></div>');
                return (
                    n.disableScrollArrowsOnFullyScrolled &&
                        o.add(s).addClass(T.CSS_CLASSES.SCROLL_ARROW_DISABLE),
                    r.append(o, l.append(c.append(t)), s)
                );
            }
            function a(t, n) {
                return e('<a role="tab" data-toggle="tab"></a>')
                    .attr("href", "#" + t[n.paneId])
                    .html(t[n.title]);
            }
            function o() {
            ...
            function i(t, n, r) {
                ...
                return (
                    t[n.disabled]
                        ? (i.addClass("disabled"), s.attr("data-toggle", ""))
                        : r.forceActiveTab &&
                          t[n.active] &&
                          i.addClass("active"),
            ...
            function s(t, n, r) {
                var a = e('<div role="tabpanel" class="tab-pane"></div>')
                    .attr("id", t[n.paneId])
                    .html(t[n.content]);
                return (
                    r.forceActiveTab && t[n.active] && a.addClass("active"), a
                );
            }
            return {
                getElTabPaneForLi: t,
        ...
        L = (function () {
            ...
            function n(e, t) {
                for (
                    var n = e.length - 1, r = -1, a = 0, o = 0;
                    -1 === r && o >= 0;

                )
                    (((o = t + ++a) <= n && !e.eq(o).hasClass("disabled")) ||
                        ((o = t - a) >= 0 && !e.eq(o).hasClass("disabled"))) &&
                        (r = o);
                return r;
            }
            function r(e, t, n) {
            ...
            function a(t, n, r) {
                t.data({ tab: e.extend({}, n[r]), index: r });
            }
            return {
                didTabOrderChange: t,
        ...
        E = {
            ...
            init: function (t) {
                ...
                return a.tabs
                    ...
                    : n.each(function (t) {
                          var o = { isWrapperOnly: !0 };
                          s(
                              e(this).data({ scrtabs: o }),
                              a,
                              t < r
                                  ? null
                                  : function () {
    ...
    (e.fn.scrollingTabs = function (t) {
        return E[t]
            ...
            : t && "object" != typeof t
            ? void e.error(
                  "Method " + t + " does not exist on $.scrollingTabs."
              )
...
$(() => {
    ...
    if (f) {
        ...
        const n = document.querySelector(
            '#popular_providers [data-toggle="tab"]'
        );
        n && n.click();
    }
    ...
    if (n) {
        ...
        i.onclick = () => {
            const i = Math.ceil(n.querySelector("a").clientWidth),
                ...
                f = Math.ceil(r * i);
            if (r < 0) {
                $(n).animate({ scrollLeft: u * i }, t);
                return;
            }
            if (u - r == 1 && n.scrollLeft - f < i) {
                $(n).animate({ scrollLeft: Math.ceil((r - 1) * i) }, t);
                return;
            }
            $(n).animate({ scrollLeft: f }, t);
        };
        r.onclick = () => {
            const i = Math.ceil(n.querySelector("a").clientWidth),
                r = Math.ceil(n.scrollLeft / i) + 1,
                ...
                u = Math.ceil(r * i);
            if (r >= f) {
                $(n).animate({ scrollLeft: 0 }, t);
                return;
            }
            if (
                n.scrollWidth - n.scrollLeft <= n.clientWidth &&
                n.scrollWidth - u < n.clientWidth
            ) {
                $(n).animate({ scrollLeft: 0 }, t);
                return;
            }
            $(n).animate({ scrollLeft: u }, t);
        };
    }
    ...
    if (t) {
        ...
        i.onclick = () => {
            const i = Math.ceil(t.querySelector(".game-item").clientWidth) * 2,
                ...
                f = Math.ceil(r * i);
            if (r < 0) {
                $(t).animate({ scrollLeft: u * i }, n);
                return;
            }
            if (u - r == 1 && t.scrollLeft - f < i) {
                $(t).animate({ scrollLeft: Math.ceil((r - 1) * i) }, n);
                return;
            }
            $(t).animate({ scrollLeft: f }, n);
        };
        r.onclick = () => {
            const i = Math.ceil(t.querySelector(".game-item").clientWidth) * 2,
                r = Math.ceil(t.scrollLeft / i) + 1,
                ...
                u = Math.ceil(r * i);
            if (r >= f) {
                $(t).animate({ scrollLeft: 0 }, n);
                return;
            }
            if (
                t.scrollWidth - t.scrollLeft <= t.clientWidth &&
                t.scrollWidth - u < t.clientWidth
            ) {
                $(t).animate({ scrollLeft: 0 }, n);
                return;
            }
            $(t).animate({ scrollLeft: u }, n);
        };
    }
    ...
    if (i) {
        ...
        t.onclick = () => {
            const t = Math.ceil(i.querySelector(".game-item").clientWidth) * 2,
                ...
                f = Math.ceil(r * t);
            if (r < 0) {
                $(i).animate({ scrollLeft: u * t }, n);
                return;
            }
            if (u - r == 1 && i.scrollLeft - f < t) {
                $(i).animate({ scrollLeft: Math.ceil((r - 1) * t) }, n);
                return;
            }
            $(i).animate({ scrollLeft: f }, n);
        };
        r.onclick = () => {
            const t = Math.ceil(i.querySelector(".game-item").clientWidth) * 2,
                r = Math.ceil(i.scrollLeft / t) + 1,
                ...
                u = Math.ceil(r * t);
            if (r >= f) {
                $(i).animate({ scrollLeft: 0 }, n);
                return;
            }
            if (
                i.scrollWidth - i.scrollLeft <= i.clientWidth &&
                i.scrollWidth - u < i.clientWidth
            ) {
                $(i).animate({ scrollLeft: 0 }, n);
                return;
            }
            $(i).animate({ scrollLeft: u }, n);
        };
    }
    ...
    if (r) {
        ...
        t.onclick = () => {
            const t = Math.ceil(r.querySelector(".game-item").clientWidth),
                ...
                f = Math.ceil(i * t);
            if (i < 0) {
                $(r).animate({ scrollLeft: u * t }, n);
                return;
            }
            if (u - i == 1 && r.scrollLeft - f < t) {
                $(r).animate({ scrollLeft: Math.ceil((i - 1) * t) }, n);
                return;
            }
            $(r).animate({ scrollLeft: f }, n);
        };
        i.onclick = () => {
            const t = Math.ceil(r.querySelector(".game-item").clientWidth),
                i = Math.ceil(r.scrollLeft / t) + 1,
                ...
                u = Math.ceil(i * t);
            if (i >= f) {
                $(r).animate({ scrollLeft: 0 }, n);
                return;
            }
            if (
                r.scrollWidth - r.scrollLeft <= r.clientWidth &&
                r.scrollWidth - u < r.clientWidth
            ) {
                $(r).animate({ scrollLeft: 0 }, n);
                return;
            }
            $(r).animate({ scrollLeft: u }, n);
        };
    }
