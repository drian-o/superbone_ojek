        ...
        const t = document.querySelector("#bank_info"),
            ...
            o = (function () {
                const n = t.querySelector("#bank_info_account_name"),
                    ...
                    h = t.querySelector(
                        "#bank_info_account_number_header_container"
                    ),
                    c = document.querySelector(
                        "#bank_info_account_no_hidden_input"
                    ),
                    l = document.querySelector(
                        "#transaction_receipt_container"
                    );
                return (a) => {
                    ...
                    a &&
                        a.dataset.bankName &&
                        (e(a.dataset.bankName, {
                            withQrCode: !!a.dataset.qrCode,
                        }),
                        i && (i.innerText = a.dataset.bankName),
                        n &&
                            ((n.style.display = "none"),
                            (n.innerText =
                                a.dataset.accountHolder || n.dataset.label)),
                        o &&
                            ((o.style.display = "none"),
                            (o.innerText =
                                a.dataset.accountHolder || o.dataset.label)),
                        r &&
            ...
            return () => {
                ...
                if (
                    (r &&
                        ...
                        e &&
                            ...
                            ($(r).hide(),
                            $(
                                '.pulsa_deposit_method_radio_button[value="OTHER"]'
                            ).click())),
                    o(e),
                    f.forEach((t) => {
                ...
                const h = e.dataset.qrCode,
                    c =
                        ...
                        e.dataset.qrCodeFormat.replace(".", "");
                if (
                    (s(c, h),
    ...
    window.initializeDepositPage = (t) => {
        ...
        window.initializeInputAmount({
            domElement: {
                ...
                netCreditedAmount: document.querySelector(
                    "#net_credited_amount"
                ),
                fastDepositNumber: document.querySelector(
                    "#fast_deposit_number"
                ),
        ...
        if (t.paymentType === "BANK") {
            ...
            n &&
                ...
                window.initializePaymentAccountSelection({
                    domElement: {
                        companyAccountSelect: i,
                        playerAccountSelect: n,
                    },
                    currency: t.currency,
                    translations: t.translations,
                    paymentType: t.paymentType,
        ...
        if (t.paymentType === "PULSA") {
            const n = document.querySelectorAll(
                ".pulsa_deposit_method_radio_button"
            );
            if (n.length) {
        ...
        if (t.paymentType === "CRYPTO") {
            const n = document.querySelector(
                "#from_crypto_payment_name_select"
            );
            n &&
                ((n.onchange = () => {
                    if (n.options.length !== 0) {
